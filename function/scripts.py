...
loadstring(game:HttpGet("https://raw.githubusercontent.com/1toop/vichop/main/hop.lua"))()"""
                conn.execute("INSERT OR REPLACE INTO scripts (name, content) VALUES (?, ?)", ("atlas", atlas_code))
                conn.execute("INSERT OR REPLACE INTO scripts (name, content) VALUES (?, ?)", ("vichop", vichop_code))
                conn.commit()
